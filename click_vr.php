	...
	<!--content-->
		<div class="content">
			...
			<div class="student-w3ls">
				<div class="container">
					<h3 class="tittle" colour: style="color:black ;">Vehicle Registration</h3>
					<div class="student-grids">
						<div class="col-md-6 student-grid">
						
							<ul type="circle"><br><br>
								<li><a href = "applyforvr.php"><h4><font color = "blue">Apply for Registration</h4></a></li><br><br>
								<li><a href = "infov.php"><h4><font color = "blue">Check Registration Status</h4></a></li><br><br>
							</ul>
