         ...
         <?php
          ...
          if($result)
          {
           while($row=mysqli_fetch_assoc($result))
           {
            ...
            <th>'.$ps.'</th>
            <td>
            <botton class="btn btn-primary"><a href="update.php?updateid='.$id.'" class="text-light">update</a></botton>  
			<botton class="btn btn-primary"><a href="delete.php?deleteid='.$id.'" class="text-light"> delete</a></botton>
            </td>
