	...
	<!--content-->
		<div class="content">
			...
			<div class="student-w3ls">
				<div class="container">
					<h3 class="tittle" style="color:black;">Driver's Licence</h3>
					<div class="student-grids">
						<div class="col-md-6 student-grid">
						
							<ul type="circle"><br><br>
								<li><a href = "applyfordl.php"><h4><font color = "blue">Apply for DL</h4></a></li><br><br>
								<!--<li><a href = "#"><h4><font color = "green">Take LLR Test</h4></a></li><br><br>-->
								<li><a href = "infod.php"><h4><font color = "blue">Check DL status</h4></a></li><br><br>
							</ul>
				...
				<div class="container">
					<div class="footer-grids">
						<div class="col-md-8 footer-grid">
							<h4>About Us</h4>
							<p>  Organisation of the Indian government responsible for maintaining a database of drivers and a database of vehicles for Andhra prsdesh.<span>
