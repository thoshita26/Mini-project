...
<!--banner-->
	<!--content-->
        ...
        <form  method="post" action="adddl.php">
            ...
            <p>
               <label for="ll_no">ll_no:</label>
               <input type="text" name="ll_no" id="ll_no">
            </p>
            <p>
			...
			<p>
               ...
               <input type="text" name="statuss" id="statuss">
            </p>
			<p>
        ...
        <th>'.$address.'</th>
            ...
            <td>
            <botton class="btn btn-primary"><a href="updated.php?updateid='.$ll_no.'" class="text-light">update</a></botton>  
			<botton class="btn btn-primary"><a href="deleted.php?deleteid='.$ll_no.'" class="text-light"> delete</a></botton>
            </td>
