...
<!--banner-->
	<!--content-->
        ...
        <form  method="post" action="addv.php">
             
        <p>
               <label for="temporary_number">Temporary No:</label>
               <input type="text" name="temporary_number" id="temporary_number">
            </p>
            ...
            <p>
               <label for="guardianphoneno">Guardian_Phone_no:</label>
               <input type="text" name="guardianphoneno" id="guardianphoneno">
            </p>
			<p>
        ...
        <th>'.$chassis.'</th>
            ...
            <td>
            <botton class="btn btn-primary"><a href="updatevr.php?updateid='.$aadhar.'" class="text-light">update</a></botton>  
			<botton class="btn btn-primary"><a href="deletev.php?deleteid='.$aadhar.'" class="text-light"> delete</a></botton>
            </td>
