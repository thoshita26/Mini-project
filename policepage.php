...
if ($conn->connect_error) {
  ...
  <table style="width:70%">
    ...
    <?php
    $sql = "SELECT temporary_number,name,phoneno,guardian,guardianphoneno,aadhar,chassis_no, engine_no,vehicle_class,color,fuel_type,seating,password2,statuss,permanent FROM vr WHERE permanent= $ab";
