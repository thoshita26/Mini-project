						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<nav class="link-effect-2" id="link-effect-2">
								...
								<li><a href="userpage.php"><span data-hover="Home">Home</span></a></li>
                                    ...
                                    <li><a href="click_challan.php"><span data-hover="DL renew">check challan</span></a></li>
	...
	<!--content-->
		<div class="content">
			...
			<div class="student-w3ls">
				<div class="container">
					<h3 class="tittle" style="color:black ;">Check challan</h3>
					<div class="student-grids">
						<div class="col-md-6 student-grid">
						
							<ul type="circle"><br><br>
								<li><a href = "challanvr.php"><h4><font color = "blue">Challan by vehicle number</h4></a></li><br><br>
								<li><a href = "challandl.php"><h4><font color = "blue">Challan by Driving license number</h4></a></li><br><br>
							</ul>
