				...
				<!-- Collect the nav links, forms, and other content for toggling -->
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<nav class="link-effect-2" id="link-effect-2">
                                ...
                                <li><a href="addpolice.php"><span data-hover="manage_police">manage_police</span></a></li>
                                    <li><a href="addtraffic.php"><span data-hover="manage_traffic">manage_traffic</span></a></li>
									<li><a href="addlearner.php"><span data-hover="managell">Manage LL</span></a></li>
									<li><a href="adddriver.php"><span data-hover="DL">Manage DL</span></a></li>
                                    <li><a href="addvr.php"><span data-hover="VR">Manage vr</span></a></li>
                                    <li><a href="addchallan.php"><span data-hover="challan">Manage Challan</span></a></li>
								</ul>
							</nav>
						</div>
					</div>
		...
		<div id="kb" class="carousel kb_elastic animate_text kb_wrapper" data-ride="carousel" data-interval="6000" data-pause="hover">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item active">
                    <img src="images/kk1.jpeg" alt="" class="img-responsive" />
                ...
                <!-- Second-Slide -->
                <div class="item">
                    <img src="images/kk2.jpg" alt="" class="img-responsive" />
                ...
                <!-- Third-Slide -->
                <div class="item">
                    <img src="images/kk3.jpeg" alt="" class="img-responsive" />
...
<!--banner-->
	<!--content-->
			...
			<div class="welcome-w3">
				<div class="container">
					<h2 class="tittle" style="color:blue;" >Welcome To RTO Andhra Pradesh  </h2>
					<div class="wel-grids">
						<div class="col-md-4 wel-grid">
							<div class="port-7 effect-2">
								<div class="image-box">
									<img src="images/pp1.jpg" class="img-responsive" alt="Image-2">
								</div>
								<div class="text-desc">
									<h4 >Put on your seat belt</h4>
								</div>
							</div>
							<div class="port-7 effect-2" >
								<div class="image-box">
									<img src="images/pp2.jpg" class="img-responsive" alt="Image-2">
								</div>
								<div class="text-desc">
									<h4>Maintain a speed limit</h4>
								</div>
							</div>
						</div>
						<div class="col-md-4 wel-grid">
							<img src="images/pp3.jpg"  class="img-responsive" alt="Image-2">
							<div class="text-grid">
								<h4>know the traffic signs</h4>
							</div>
						</div>
						<div class="col-md-4 wel-grid">
							<div class="port-7 effect-2">
								<div class="image-box">
									<img src="images/pp4.jpg" class="img-responsive" alt="Image-2">
								</div>
								<div class="text-desc">
									<h4>wear a helmet</h4>
								</div>
							...
							<div class="port-7 effect-2">
								<div class="image-box">
									<img src="images/pp5.png" class="img-responsive" alt="Image-2">
								</div>
								<div class="text-desc">
